...
const groups = [
  ...
  ["AI", [["model", "โมเดล", "default", "select", ["default", "fast", "balanced", "quality"]], ["temperature", "Temperature", 0.7, "number"], ["maxTokens", "Max tokens", 4096, "number"], ["streaming", "ตอบแบบสตรีม", true, "boolean"], ["systemPrompt", "System prompt", "", "text"]]],
